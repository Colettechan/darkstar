...
-- DYNAMIS SETTINGS
    ...
    TIMELESS_HOURGLASS_COST = 5000;   -- cost of the timeless hourglass for Dynamis.
...
RELIC_2ND_UPGRADE_WAIT_TIME = 60;      -- wait time for 2nd relic upgrade (stage 2 -> stage 3) in seconds. 604800s = 1 RL week.
RELIC_3RD_UPGRADE_WAIT_TIME = 20;      -- wait time for 3rd relic upgrade (stage 3 -> stage 4) in seconds. 295200s = 82 hours.
...
AF1_QUEST_LEVEL = 30; -- Minimum level to start AF1 quest
AF2_QUEST_LEVEL = 40; -- Minimum level to start AF2 quest
AF3_QUEST_LEVEL = 40; -- Minimum level to start AF3 quest
AF1_FAME = 20; -- base fame for completing an AF1 quest
AF2_FAME = 40; -- base fame for completing an AF2 quest
AF3_FAME = 40; -- base fame for completing an AF3 quest
...
FrigiciteDuration = 300; -- When OldSChoolG2 is enabled, this is the time (in seconds) you have from killing Boreal NMs to click the "???" target.
...
RIVERNE_PORTERS = 1200; -- Time in seconds that Unstable Displacements in Cape Riverne stay open after trading a scale.
...
-- ABYSSEA
VISITANT_BONUS = 4.00; -- Default: 1.00 - (retail) - Multiplies the base time value of each Traverser Stone.